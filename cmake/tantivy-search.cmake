...
# Pre-built tantivy-search library
if(NOT EXISTS ${TANTIVY_SEARCH_LIBRARIES})
  message(FATAL_ERROR "Pre-built tantivy-search library not found at ${TANTIVY_SEARCH_LIBRARIES}")
endif()
